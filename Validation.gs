function refreshDropdowns() {
  ...
  mbSheet_('Promos').getRange(6,2,MB.ROWS-5,1).setDataValidation(rule('H2:H100'));
  mbSheet_('Promos').getRange(6,3,MB.ROWS-5,1).setDataValidation(rule('A2:A100'));
  mbSheet_('Promos').getRange(6,7,MB.ROWS-5,1).setDataValidation(rule('K2:K100'));
