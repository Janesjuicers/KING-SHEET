const MB = Object.freeze({
  ...
  PROMO_HEADERS: ['Date','Account','Promo Type','Notes','Turnover','Odds','Result','EV Taken','Cash Change','Bonus Change'],
  PROMO_HEADER_ROW: 5,
  PROMO_DATA_ROW: 6,
  ...
  MONTH_HEADERS: ['Month','Promo Turnover','Promo EV Taken','Promo EV %','Promo Actual PnL','Promo POT %','BTO Turnover','BTO EV Taken','Expected BTO %','BTO Actual Return','Actual BTO %','Non-Promo Turnover','Non-Promo EV','Non-Promo EV %','Non-Promo Actual PnL','Non-Promo POT %','Overall EV','Overall Actual PnL','Cumulative EV','Cumulative PnL'],
