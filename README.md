...
* **Accounts:** one calculated row is generated per active Account ID. Cash is deposits less pending/approved withdrawals plus Promo Cash Change, BTO Bookie Change, and NonPromo Bookie Change. Bonus is bonus received plus Promo Bonus Change less BTO Turnover. Risk is pending withdrawals plus positive cash/bonus held in BAN or StatDec accounts.
...
* **BTO:** the 14 visible columns are Date, Account, BTO Method, Notes, Turnover, Odds, optional BSP, Result, EV Taken, Bookie Change, Betfair Lay, Lay Odds, Commission, and Betfair Change. EV Taken and both change columns are protected formulas; actual return in reports is Bookie Change plus Betfair Change.
* **NonPromos:** the 15 visible columns are Date, Account, Non-Promo Type, Notes, Turnover, Odds, BSP, Result, Expected EV, EV %, Bookie Change, Betfair Lay, Lay Odds, Commission, and Betfair Change. Expected EV, EV %, and both change columns are protected formulas.
* **EV Breakdown:** Reporting Period is in B5; for Custom, Custom From is B3 and Custom To is B4. Window From/To in B6:B7 are calculated.
